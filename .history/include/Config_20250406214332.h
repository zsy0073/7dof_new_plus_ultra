...
// 基本舵机控制参数 - 增加安全值
#define SERVO_MOVE_TIME 700     // 增加默认移动时间，降低速度
#define MIN_MOVE_TIME 200       // 增加最小移动时间，避免突变
#define MAX_MOVE_TIME 1500      // 最大移动时间(毫秒)

// 舵机平滑移动参数 - 增加安全死区
#define MOVE_STEP_TIME 50       // 每步默认移动时间(毫秒)
#define POSITION_DEADZONE 10    // 增加位置死区(忽略小变化)
#define MIN_COMMAND_INTERVAL 100 // 增加命令最小间隔(毫秒)
